...
import 'package:vc_admin/Pages/ManageDatabase/Designs/Piping/CreatePipingDesign.dart';
import 'package:vc_admin/Pages/ManageDatabase/Designs/Sleeve/CreateSleeveDesign.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
class ManagePiping extends StatefulWidget {
  @override
  _ManagePipingState createState() => _ManagePipingState();
}

class _ManagePipingState extends State<ManagePiping> {
  @override
  ProgressDialog pr;
  @override
        ...
        children: [
          Container(
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('Designs').where('Type',isEqualTo: 'PipingDesign').snapshots(),
                  builder: (BuildContext context,

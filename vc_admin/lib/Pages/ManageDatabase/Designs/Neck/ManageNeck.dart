...
import 'package:vc_admin/Pages/ManageDatabase/Designs/Neck/CreateNeckDesign.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
class ManageNeck extends StatefulWidget {
  @override
  _ManageNeckState createState() => _ManageNeckState();
}

class _ManageNeckState extends State<ManageNeck> {
  @override
  ProgressDialog pr;
  @override
        ...
        children: [
          Container(
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('Designs').where('Type',isEqualTo: 'NeckDesign').snapshots(),
                  builder: (BuildContext context,
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: IconButton(
                                      ...
                                      icon: Icon(Icons.delete_outline_rounded,size: 25.sp,),
                                      color: Theme.of(context).accentColor,
                                    ),
                                  ),
                                ]),

...
class CreateNeck extends StatefulWidget {
  @override
  _CreateNeckState createState() => _CreateNeckState();
}

class _CreateNeckState extends State<CreateNeck> {
  @override
  ...
  Future uploadData(BuildContext context) async {
    ...
    if(designName == null || designPrice == null ){
      ...
      await pr.show();
      DocumentReference mneck = FirebaseFirestore.instance.collection('Designs').doc();
      String mnid = mneck.id;
      String fileName = basename(_imageFile.path);
      Reference firebaseStorageRef = FirebaseStorage.instance.ref().child('Designs/$mnid/$fileName');

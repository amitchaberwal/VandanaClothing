...
import 'package:vc_admin/Pages/ManageDatabase/Designs/Collar/AddCollar.dart';
import 'package:vc_admin/Pages/ManageDatabase/Designs/Sleeve/CreateSleeveDesign.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
class ManageCollar extends StatefulWidget {
  @override
  _ManageCollarState createState() => _ManageCollarState();
}

class _ManageCollarState extends State<ManageCollar> {
  @override
  ProgressDialog pr;
  @override
        ...
        children: [
          Container(
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('Designs').where('Type',isEqualTo: 'CollarDesign').snapshots(),
                  builder: (BuildContext context,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('₹' + document['Price'].toString(),style: TextStyle(color: Theme.of(context).secondaryHeaderColor,fontSize: 16.sp,fontWeight: FontWeight.w300),),
                                          ),
                                        ],
                                      )
                                    ],

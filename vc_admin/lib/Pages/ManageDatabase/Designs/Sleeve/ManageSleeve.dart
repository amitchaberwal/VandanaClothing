...
class ManageSleeve extends StatefulWidget {
  @override
  _ManageSleeveState createState() => _ManageSleeveState();
}

class _ManageSleeveState extends State<ManageSleeve> {
  @override
  ProgressDialog pr;
  @override
        ...
        children: [
          Container(
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('Designs').where('Type',isEqualTo: 'SleeveDesign').snapshots(),
                  builder: (BuildContext context,

                    ...
                    children: snapshot.data.docs
                        .map(
                          (document) => Padding(
                            ...
                            child: FutureBuilder(
                                future: FirebaseFirestore.instance.collection('Products').doc(document.id).get(),
                                builder: (context,
                                    AsyncSnapshot<DocumentSnapshot> mdata) {
                                  if (mdata.hasData) {
                                    if(mdata.data.exists){
                                      return ProductTile(
                                        pro_name: mdata.data['ProductName'],
                                        pro_img: mdata.data['ProductImage'],
                                        pro_price: mdata.data['ProductPrice'],
                                        pro_discount: mdata.data['ProductDiscount'],
                                        pro_subcat: mdata.data['SubCategoryName'],
                                        pro_id: document.id,
                                      );
                                    }
                                    else{
                                      FirebaseFirestore.instance.collection('Users').doc(FirebaseAuth.instance.currentUser.phoneNumber).collection('Favourites').doc(mdata.data.id).delete();
                                      return Container(
                                        width: 170.w,
                                        height: 255.h,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Icon(Icons.error_outline_outlined,color: Theme.of(context).accentColor,size: 45.r,),
                      ...
                      : Stack(fit: StackFit.expand, children: [
                          CachedNetworkImage(
                            ...
                            placeholder: (context, url) => Center(
                                child: Image.asset("images/Ripple2.gif")),
                          ),
                          Align(
